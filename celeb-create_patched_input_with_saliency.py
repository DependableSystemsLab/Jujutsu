...
parser.add_argument('--model_path', type=str, default='facial_identity_ResNet18.pth')
...
save_folder2 = "{}/celeb_{}_{}_npy_test_org_result_{}".format(args.save_folder.rstrip("/"), args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
save_folder22 = "{}/celeb_{}_{}_npy_test_adv_result_{}".format(args.save_folder.rstrip("/"), args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
save_folder222 = "{}/celeb_{}_{}_npy_test_org_saliency_{}".format(args.save_folder.rstrip("/"),args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
save_folder2222 = "{}/celeb_{}_{}_npy_test_adv_saliency_{}".format(args.save_folder.rstrip("/"), args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
