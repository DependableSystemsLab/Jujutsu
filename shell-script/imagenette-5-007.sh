...
python test.py --gpu_ids 0 --name imagenet_random --mask_type 4 --img_file ../imagenette_5_square_r51_adv_test_detected_007_with_coordinate \
            --results_dir ./imagenette_square_5_r51_adv_test_detected_007_100/ --mask_pert 1. --is_square_patch 1 --batchSize 16 
python test.py --gpu_ids 0 --name imagenet_random --mask_type 4 --img_file ../imagenette_5_square_r51_org_test_misdetected_007_with_coordinate \
...
rm -rf imagenette_square_5_npy_test_adv_saliency_007
rm -rf imagenette_square_5_npy_test_adv_result_007
rm -rf imagenette_square_5_npy_test_org_saliency_007
rm -rf imagenette_square_5_npy_test_org_result_007
rm -rf imagenette_5_square_2feature_transfer_adv_comp_007
rm -rf imagenette_5_square_1feature_transfer_adv_comp_007
rm -rf imagenette_5_square_2feature_transfer_org_comp_007
rm -rf imagenette_5_square_1feature_transfer_org_comp_007

rm -rf imagenette_5_square_r51_adv_test_detected_007_with_coordinate
rm -rf imagenette_5_square_r51_adv_test_detected_007
rm -rf imagenette_5_square_r51_org_test_misdetected_007_with_coordinate
rm -rf imagenette_5_square_r51_org_test_misdetected_007

rm -rf Pluralistic-Inpainting/imagenette_square_5_r51_adv_test_detected_007_100
rm -rf Pluralistic-Inpainting/imagenette_square_5_r51_org_test_misdetected_007_100
