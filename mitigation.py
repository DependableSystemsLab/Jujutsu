...
def main() -> None:
    ...
    if(args['extract_label']):
        print( "Num of image that remains the targeted adv label after mitigation: ", remain_targeted_label )
        print(" Recovered {} out of {}, Robust accuracy = {:.4f}".format(recover, cnt, recover/cnt))
    else:
        print("Num of image that remains the same label before and after masking/inpainting: {} out of {}".format(recover, cnt))
