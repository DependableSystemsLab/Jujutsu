...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--iterative_mask', type=int, default=1, help='iteratively place mask in the image')
        ...
        parser.add_argument('--loadSize', type=int, default=[224, 224], help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=[224, 224], help='then crop to this size')
