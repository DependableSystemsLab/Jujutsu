...
parser.add_argument('--data_dir', type=str, default='./CelebA_HQ_facial_identity_dataset', help="dir of the dataset")
...
for epoch in range(args.epochs):
    ...
    print("Epoch:{} Patch attack success rate on trainset: {:.3f}%".format(epoch+1, 100 * train_success / train_actual_total), flush=True)
    ...
    print("Epoch:{} Patch attack success rate on testset with universal patch: {:.3f}%".format(epoch+1, 100 * test_success_rate), flush=True)
    ...
    if test_success_rate > best_patch_success_rate:
        ...
        patch_name = "celeb_{}_best_org_patch_{}_{}.npy".format(args.patch_type, str(args.noise_percentage).replace('.', ''), str(args.target))
