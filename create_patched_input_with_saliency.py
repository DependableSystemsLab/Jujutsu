...
save_folder2 = "./{}_{}_{}_npy_test_org_result_{}".format(args.model, args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
save_folder22 = "./{}_{}_{}_npy_test_adv_result_{}".format(args.model, args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
save_folder222 = "./{}_{}_{}_npy_test_org_saliency_{}".format(args.model, args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
save_folder2222 = "./{}_{}_{}_npy_test_adv_saliency_{}".format(args.model, args.patch_type, args.target, str(args.noise_percentage).replace('.', ''))
